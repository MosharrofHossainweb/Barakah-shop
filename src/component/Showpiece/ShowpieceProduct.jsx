...
import showpieceData from "../../DB/showpieceData";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {showpieceData.length > 0 ? (
          showpieceData.map((item, index) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col justify-between flex-grow">
                  ...
                  >
                    <li>
                      Material:{" "}
                      <span className="text-green-500">{item.material}</span>
                    </li>
                    <li>
                      Size:{" "}
                      <span className="text-green-500">{item.size}</span>
                    </li>
                    <li>
                      Color:{" "}
                      <span className="text-green-500">{item.color}</span>
                    </li>
                    <li>
                      Category:{" "}
          ...
          <p className={`${textColor} text-lg`}>
            No showpieces available at the moment.
          </p>
        )}
      </div>
    </div>
